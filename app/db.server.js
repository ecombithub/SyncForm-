...
//             const response = id
//                 ? await axios.put(`http://localhost:5001/update/${id}`, formData)
//                 : await axios.post('http://localhost:5001/send/api', formData);
...
//     const handleColumnClick = (fieldId, Index) => {
//         setPopupFieldId(fieldId);

//         setFields((prevFields) =>
//             prevFields.map((field) =>
//                 field.id === fieldId
//                     ? { ...field, selectedColumn: Index }
//                     : field
//             )
//         );
//     };
...
//                                                                                             type="file"
//                                                                                             accept="image/*"
//                                                                                             onChange={(e) => handleImageUpload1(e, field.id, index)}
//                                                                                         />
//                                                                                         {field.columnData[index].image && (
//                                                                                             <div>
//                                                                                                 <p>Image preview:</p>
...
//                                                                                     </div>
//                                                                                 ))}
//                                                                                 <button onClick={() => addColumn(field.id)}
//                                                                                 >Add Column</button>
//                                                                             </div>
