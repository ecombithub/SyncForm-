...
const EmailTemplateCreate = () => {
    ...
    const createInputField = (type, add, initialValue = '') => {
        ...
        return {
            ...
            dividerAline: type === 'divider' ? 'center' : undefined,
                                                                                ...
                                                                                <div className='setting_bg_email_templetes'>
                                                                                    {Array.from({ length: field.columnCount }, (_, index) => (
                                                                                        <div key={index} className="column-setting">
                                                                                            ...
                                                                                            <div className='form-builder-chaneging-wrap file' onClick={() => document.getElementById(`file-input-${field.id}-${index}`).click()} style={{ display: field.columnData[index].image ? 'none' : 'block', cursor: 'pointer' }}>
                                                                                                <input
                                                                                                    type="file"
                                                                                                    accept="image/*"
                                                                                ...
                                                                                <div>
                                                                                    {field.value ? (
                                                                                        <div>
                                                                                            ...
                                                                                            <button className='update-image img rm-btn' onClick={() => setImageFieldId(field.id)}>
                                                                                                Update Image
                                                                                            </button>
                                                                                        ...
                                                                                        <div>
                                                                                            {!imageFieldId || imageFieldId !== field.id ? (
                                                                                                <button className='update-image img' onClick={() => setImageFieldId(field.id)}>
                                                                                                    Upload Image
                                                                                                </button>
                                                                                            ) : null}
                                                                                        </div>
