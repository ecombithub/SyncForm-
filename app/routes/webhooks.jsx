            ...
            <div className="builder-container">
                                                ...
                                                <div className='edit_form_close'>
                                                    <div className='edit-formwrap'>
                                                        ...
                                                        <div className='form_builder_submission'>
                                                            <h2 onClick={() => setDropdownVisible(!isDropdownVisible)} style={{ cursor: 'pointer' }}>
                                                                Form Submission
                                                            </h2>
                                                        ...
                                                        <div className='edit-form-options'>
                                                            ...
                                                            {/* <div className='edit_setting_bg padding'>
                                                                <label>Padding:</label>
                                                                <input
                                                                    type="range"
                                                                    min="0"
                ...
                <div className='btn_form_bulider'>
                    <div className="form-submission-wrp">
                        <button className="cancle-form-btn" onClick={handlelistForm}>Cancle</button>
                    </div>
                    <div className="form-submission-wrp">
                            ...
                            {radioOptions.map((option, index) => (
                                <div key={option.id} className="radio-option">
                                    <label style={{ display: 'flex', alignItems: 'center' }}>
                                        ...
                                        />
                                        <button onClick={() => removeRadioOption(option.id)} className="remove-options"> -</button>
                                    </label>
