...
const EmailTemplateCreate = () => {
    ...
    const [templatePadding, setTemplatePadding] = useState('20px');
    ...
    const createInputField = (type, initialValue = '') => {
        ...
        return {
            ...
            headingTextAlign: type === 'heading' ? "left" : undefined,
            headingColor: type === 'heading' ? '#000' : undefined,
            headingbg: type === 'heading' ? '#ffffff' : undefined,
            ...
            imgTextAlign: type === 'images' ? "left" : undefined,
    ...
    const createOrUpdateForm = async () => {
        ...
        const updatedFields = validFields.map(field => {
            ...
            return {
                ...
                headingTextAlign: field.headingTextAlign || 'left',
                ...
                descriptionTextAlign: field.descriptionTextAlign || 'left',
                ...
                buttonradious: field.buttonHeight || 40,
                ...
                imgTextAlign: field.imgTextAlign || 'left',
                            ...
                            <select onChange={handleFormSelect}>
                                ...
                                {formDataAdd.map((form) => (
                                    <option
                                        ...
                                        value={form.title}
                                        style={{
                                            color: selectedFormIds.includes(form.formId) ? 'red' : 'black',
                                        }}
                                    >
                                        {form.title}
                                    </option>
                                        ...
                                        <div className='builder_fieldes'>
                                            ...
                                            {showFields ? (
                                                <div>
                                                    ...
                                                    <div className='builderr_field_wrpp'> <button onClick={() => addInputField('split')}><span className='form_builder_field_img'><img src={image} alt="" /></span> <span><h4>Split</h4></span></button></div>
                                                    <div className='builderr_field_wrpp'> <button onClick={() => addInputField('spacer')}><span className='form_builder_field_img'><img src={image} alt="" /></span> <span><h4>Spacer</h4></span></button></div>
                                                                ...
                                                                return (
                                                                    <div key={field.id} className="description-field">
                                                                        ...
                                                                        <div className="form-builder-chaneging-wrap">
                                                                            ...
                                                                            <div className='form-builder-chaneging-wrap'>
                                                                                <label>
                                                                                    <button className='update-image'
                                                                                        type="button"
                                                                                        onClick={() => handleToggleIcon('facebook')}
                                                                                    >
                                                                                        {selectedIcons.facebook.isHidden ? 'Show' : 'Hide'}
                                                                                    </button>
                                                                            ...
                                                                            <div className='form-builder-chaneging-wrap'>
                                                                                <label>
                                                                                    <button className='update-image'
                                                                                        type="button"
                                                                                        onClick={() => handleToggleIcon('twitter')}
                                                                                    >
                                                                                        {selectedIcons.twitter.isHidden ? 'Show' : 'Hide'}
                                                                                    </button>
                                                                            ...
                                                                            <div className='form-builder-chaneging-wrap'>
                                                                                <label>
                                                                                    <button className='update-image'
                                                                                        type="button"
                                                                                        onClick={() => handleToggleIcon('instagram')}
                                                                                    >
                                                                                        {selectedIcons.instagram.isHidden ? 'Show' : 'Hide'}
                                                                                    </button>
                                                                                ...
                                                                                <div>
                                                                                    {customIcons.map((icon, index) => (
                                                                                        <div key={index} className='form-builder-chaneging-wrap  '>
                                                                                            ...
                                                                                            />
                                                                                            <button className='update-image' onClick={() => toggleCustomIconVisibility(index)}>
                                                                            ...
                                                                            <button className='update-image' onClick={handleSaveSocialIcons}>Save</button>
                                                                            <button className='update-image' onClick={() => setShowSocialIconPopup(false)}>Cancel</button>
                                                                        </div>
                                                                        <div className='form-builder-chaneging-wrap number'>
