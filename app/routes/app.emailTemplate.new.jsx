...
const EmailTemplateCreate = () => {
    ...
    const createInputField = (type, add, initialValue = '') => {
        ...
        return {
            ...
            bannerImageHeight: type === 'heading' ? '100%' : undefined,
                                                            ...
                                                            if (field.type === 'heading') {
                                                                ...
                                                                return (
                                                                    <div
                                                                        ...
                                                                        style={{ display: 'flex', height: field.bannerImageHeight || '100%', }}
                                                                    >
                                                                        ...
                                                                        >
                                                                            <div className='email-input-field-h1' style={{
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    style={{ fontSize: `${field.headingsubheading}px`, fontFamily: field.subheadingfamily, lineHeight: `${field.subheadingline}px`, color: field.subheadingColor, letterSpacing: `${field.subheadingleter}px` }}
                                                                        ...
                                                                        >
                                                                            {field.add === 'image' ? (
                                                                                ...
                                                                                <div style={{ width: '100%', display: 'flex', alignItems: field.splittext === 'left' ? 'flex-start' : field.splittext === 'center' ? 'center' : 'flex-end' }}>
                                                                                    <div style={{ width: '100%' }}>
                                                                                        <div style={{ width: '100%' }} dangerouslySetInnerHTML={{ __html: field.value || 'Use this section to add reviews or testimonials from your store’s happy customers Use this section to add reviews or testimonials from your store’s happy customers ...' }} />
                                                                                        <div >
                                                                                            {field.showbtnsplit && (
                                                                ...
                                                                if (field.id === selectedFieldId && field.type === 'heading') {
                                                                    return (
                                                                        <div key={field.id}>
                                                                            ...
                                                                            <div className="form-builder-chaneging-wrap number">
                                                                                <label> Subheading Font-Family</label>
                                                                                <select
                                                                            ...
                                                                            <div className='form-builder-chaneging-wrap number'>
                                                                                <label> Subheading Letter Spacing</label>
                                                                                <input
                                                                                    type="number"
